...
#ifndef __T3D_D3D11_VERTEX_BUFFER_H__
#define __T3D_D3D11_VERTEX_BUFFER_H__
...
namespace Tiny3D
{
     ...
     */
    class D3D11VertexBuffer : public HardwareVertexBuffer
    {
        T3D_DECLARE_CLASS();

    public:
        /**
         * @fn  static D3D11VertexBufferPtr
         ...
         */
        static D3D11VertexBufferPtr create(size_t vertexSize,
            size_t vertexCount, const void *vertices, Usage usage,
            uint32_t mode);
    ...
    protected:
         ...
         * @param [in]  mode        緩沖區訪問方式.
         */
        D3D11VertexBuffer(size_t vertexSize, size_t vertexCount,
...
#endif  /*__T3D_D3D11_VERTEX_BUFFER_H__*/
