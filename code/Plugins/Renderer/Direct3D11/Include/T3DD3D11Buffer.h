...
#ifndef __T3D_D3D11_BUFFER_H__
#define __T3D_D3D11_BUFFER_H__
...
namespace Tiny3D
{
     ...
     */
    class D3D11Buffer : public HardwareBuffer
    {
        T3D_DECLARE_CLASS();
    ...
    public:
        ...
        /**
         * @fn  static D3D11BufferPtr D3D11HardwareBuffer::create(
         ...
         */
        static D3D11BufferPtr create(BufferType type, size_t dataSize, 
    ...
    protected:
         ...
         * @param [in]  mode    緩沖區訪問方式.
         */
        D3D11Buffer(Usage usage, uint32_t mode);
    ...
    protected:
        ...
        D3D11BufferPtr  mStageBuffer;   /**< 给 D3D11_USAGE_DEFAULT 更新用 */
        D3D11_USAGE             mD3DUsage;      /**< D3D11 缓冲区用法 */
    };
}


#endif  /*__T3D_D3D11_BUFFER_H__*/
