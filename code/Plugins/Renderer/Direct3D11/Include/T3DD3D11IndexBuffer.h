...
#ifndef __T3D_D3D11_INDEX_BUFFER_H__
#define __T3D_D3D11_INDEX_BUFFER_H__
...
namespace Tiny3D
{
     ...
     */
    class D3D11IndexBuffer : public HardwareIndexBuffer
    {
        T3D_DECLARE_CLASS();

    public:
        /**
         * @fn  static D3D11IndexBufferPtr 
         ...
         */
        static D3D11IndexBufferPtr create(Type indexType,
    ...
    protected:
         ...
         * @param [in]  mode        缓冲区访问方式.
         */
        D3D11IndexBuffer(Type indexType, size_t indexCount,
            HardwareBuffer::Usage usage, uint32_t mode);
...
#endif  /*__T3D_D3D11_INDEX_BUFFER_H__*/
